...
const stationGeoCoordMap = {
    ...
    '首都国际机场': { coords: [116.609564, 40.083812], city: '北京' },
    '滨海国际机场': { coords: [117.371645, 39.133514], city: '天津' },
    '正定国际机场': { coords: [114.703893, 38.287385], city: '石家庄' },
    '北京南苑机场': { coords: [116.409387, 39.799315], city: '北京' },
    '大兴国际机场': { coords: [116.42396, 39.511576], city: '北京' },
...
Mock.mock('/api/stationtraffic', 'get', (option) => {
    ...
    let tmp = {
        rail: [
            { "hubName": "北京西站", "bearingCapacity": "60", "passengerVolume": "25.27", "relievingEfficiency": "95.08%" },
            { "hubName": "北京南站", "bearingCapacity": "100", "passengerVolume": "16.55", "relievingEfficiency": "88.95%" },
            { "hubName": "石家庄站", "bearingCapacity": "40", "passengerVolume": "12.84", "relievingEfficiency": "92.25%" },
            { "hubName": "北京站", "bearingCapacity": "30", "passengerVolume": "10.72", "relievingEfficiency": "90.91%" },
            { "hubName": "天津站", "bearingCapacity": "50", "passengerVolume": "10.23", "relievingEfficiency": "89.25%" },
            { "hubName": "天津西站", "bearingCapacity": "30", "passengerVolume": "3.54", "relievingEfficiency": "87.89%" },
            { "hubName": "唐山站", "bearingCapacity": "30", "passengerVolume": "3.31", "relievingEfficiency": "85.05%" }
        ],
        air: [
            { "hubName": "首都国际机场", "bearingCapacity": "50", "passengerVolume": "27.39", "relievingEfficiency": "90.56%" },
            { "hubName": "滨海国际机场", "bearingCapacity": "30", "passengerVolume": "6.52", "relievingEfficiency": "96.25%" },
            { "hubName": "正定国际机场", "bearingCapacity": "20", "passengerVolume": "3.27", "relievingEfficiency": "86.35%" },
            { "hubName": "大兴国际机场", "bearingCapacity": "10", "passengerVolume": "0.86", "relievingEfficiency": "95.36%" },
            { "hubName": "山海关机场", "bearingCapacity": "5", "passengerVolume": "0.07", "relievingEfficiency": "93.65%" }
        ]
    }
    let res = [];
    if (tmp[hubType]) {
        res = tmp[hubType].map(function (data) {
            return {
                ...data,
                city: stationGeoCoordMap[data.hubName].city,
                coords: stationGeoCoordMap[data.hubName].coords
            }
        });
    }
